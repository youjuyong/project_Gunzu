            ...
            <div className='intro_title_think_macro'>
                <div className='intro_div2 intro1'>
                    ...
                    <p className="king_title_pTag">
                            "유저"가 아닌 운영자가 만든 매크로를 잡기 위한 프로그램
                            <br/>
                            사냥 도중 10~20분 간격으로 판별창이 뜨고 질문 이해 하고 입력창에 직접 '입력'을 해야되는 것.
                    </p>
                </div>
                <div className="king_body_div">
                    <div className="content1">
                        <p>미리 말씀을 드리지만 판별창은 왕실과 전혀 무관한 "운영자"가 매크로를 잡기 위한 프로그램 입니다.</p>
                        <p>하지만 왕실 카메고리에 둔 이유는 맥락은 매크로 잡기로 왕실시스템과 똑같지만 </p>
                        <p>시스템적 불편함이 많고 게임하는 유저 라면 이것 때문에 수감을 한번이라도 안간적 이 없기 때문 입니다.</p>
                        <p>복귀 or 초보자 에게는 매우 중요한 사항으로 유의점 몇가지를 숙지 하고 계셔야 합니다.</p>
                        <h3>1. 무게는 반드시 소숫점을 포함해서 입력 하자.</h3>
                        ...
                        <h2>문제는 소수점을 포함안하고 "256.0"을 입력 해야 되는데 "256" 까지만 입력 해서 수감을 당하시는 분들이 굉장히 많습니다. </h2>
