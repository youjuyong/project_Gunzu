            ...
            <div className='intro_title_think_macro'>
                <div className='intro_div2 intro1'>
                    ...
                    <p className="king_title_pTag">
                            "유저"가 아닌 운영자가 매크로를 잡기 위해 인게임에 넣어둔 프로그램
                            <br/>
                            사냥 도중 10~20분 간격으로 판별창이 뜨고 질문 이해 하고 입력창에 직접 '입력'을 해야되는 것을 의미함.
                    </p>
                </div>
                <div className="king_body_div">
                    <div className="content1">
                        <p>미리 말씀을 드리지만 판별창은 왕실과 전혀 무관한 "운영자"가 매크로를 잡기 위해 인게임에 넣어 놓은 프로그램 입니다.</p>
                        <p>하지만 왕실 카메고리에 놓은 이유는 목적은 매크로 잡기로 왕실 시스템과 똑같지만 </p>
                        <p>시스템적 불편함이 많고 게임하는 유저 라면 이 것 때문에 수감을 한번씩은 당해봤기 때문에</p>
