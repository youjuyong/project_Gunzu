...
const SystemOfKingLawInfo = ( ) => {
    ...
    return (
        <>
         <MetaTag title="왕실 법안" description="왕실 법안 에대한 정보를 알려주는 페이지입니다." keywords="군주온라인, 왕실 법안"></MetaTag>
                                ...
                                <div className="page">
                                        <div className="page__content-blockquote_zno">
                                            <p className="page__content-text1">2조 [ 순찰 ]</p>
                                             ...
                                             <p className="page__content-text1_2"><span>( 예시- 순찰 거부 및 순찰 방해 )</span></p>
                                             <p className="page__content-text1_2"><span>4. 메크로 순찰멘트 시 일반채팅이 사라지고 5초까지 여유를 두고 2차 멘트를 진행한다.</span></p>
                                             <p className="page__content-text1_2"><span>5. 형조판서/포교는 동시 순찰이 가능하다.</span></p>
                            ...
                            {/* 5페이지 */}
                             <div className="book_page_content">
                                <div className="page">
                                    ...
                                    <div className="page__content-blockquote_hang">
                                        <p className="page__content-text1">1항 [ 처벌 ]</p>
                                        <p className="page__content-text1_2"><span>1. 순찰 거부로 인한 신고하기 이용권 사용 시, 1차, 경고 및 마을 소속 유저는 해당마을 대행수 보고, 2차 이상부터 120분 수감, 3차 무한수감 + 운영진 보고한다.추가적으로 순찰 거부로 불응한 자에 한하여 멘트 없이 바로 신고하기 이용권 사용 가능하다.</span></p>
                                        <p className="page__content-text1_2"><span>1-1. 순찰 불응자는 1차 대행수 알림, 2차 수감후 서버게시판에 아이디를 공개한다.(이름변경시 변경내용도 공개).</span></p>
                                        <p className="page__content-text1_2"><span>1-2. 메크로 2차 적발자 명단은 117대에서 118대까지 유효하게 적용한다 (순찰멘트없이 신고하기 이용권 사용가능).</span></p>
                                        <p className="page__content-text1_2"><span>2. 순찰 방해 : 폭언 욕설에 대한 처벌과 동일하게 처리한다. 또한 비협조 시 경고 없이 120분 수감한다.</span></p>
                                        <p className="page__content-text1_2"><span>3. 악의적 응답 : 포교의 일반 순찰 채팅 스크린샷을 기준으로 왕실 판서진의 의결을 통하여 1차 경고, 2차시 60분 수감한다. (신고하기 이용권 무단사용 적발시 왕실 사칭 관련 법안의따라 120분 수감처리한다)</span></p>
                                        <p className="page__content-text1_2"><span>4. 신고하기 이용권 제공자 (군주,6조판서,포교) 가 적발될경우 왕실자격 박탈 및 120분 수감처리한다.</span></p>
                                        <p className="page__content-text1"><span>2항 [ 순찰 및 영상 ]</span></p>
                                        <p className="page__content-text1_2"><span>1. 왕실인원 (군주,6조판서,포교) 는 메크로 순찰 시 반드시 영상을 녹화한다.</span></p>
                                        <p className="page__content-text1_2"><span>2. 순찰 종료후 순찰을 진행했던 유저(본인)이 영상을 원하는경우 열람할수있다.</span></p>
                                        <p className="page__content-text1_2"><span>3. 순찰로 피해를 입거나, 악의적인 행동으로 피해를 입은경우, 영상을 열람신청 하여 검토할수있다.</span></p>
                                        <p className="page__content-text1_2"><span>3-1. (신규) 영상검토후 왕실 및 해당 마을 대행수의 판단의따라서 비매너(120분) 수감 조치 및 운영자에게 보고한다.</span></p>
                                    </div>
                                    <div className="pageCntView"><p>- {selected + 1} / 16 -</p></div>
                                </div>
                             </div> 
                             ...
                             <div className="book_page_content">
                                <div className="page">
                                    ...
                                    <div className="page__content-blockquote_zno">
                                            ...
                                            <p className="page__content-text1_2">1. 범위 공격을 하는 게임의 특성상 범위가 겹치지 않도록, 몬스터가 몰리는 위치 [좌표]를  자리라는 개념으로 인정한다.</p>
                                ...
                                <div className="page">
                                    <div className="page__content-blockquote_hang">
                                     ...
                                     <div className="page__content-blockquote_hang">
                                            ...
                                            <p className="page__content-text1_2">5. 연속휴식에 적발되었을때  1차 경고 . 2차 60분수감. 3차 120분 수감으로 처리한다.</p>
                             ...
                             <div className="book_page_content">
                                <div className="page">
                                    ...
                                    <div className="page__content-blockquote_hang">
                                        ...
                                        <p className="page__content-text1_2">5. 사냥중 좌표에서 5보 미만 이탈은 자리이탈 로 인정하지 않는다 (모든 무기포함)</p>
                                    </div>
                                    <div className="pageCntView"><p>- {selected + 1} / 16 -</p></div>
                                </div>
                             </div> 
                                ...
                                <div className="page">
                                    ...
                                    <div className="page__content-blockquote_zno">
                                     ...
                                     <div className="page__content-blockquote_hang">
                                        ...
                                        <p className="page__content-text1_2">2. 장사관련 자막은 도배로 인정하지 않는다 단 (장사관련 내용은 같은내용으로 2번이상 적을수없다)</p>
                                        <p className="page__content-text1_2">3. 장사관련 같은 내용을 2번이상 지속적으로 자막을 사용할경우 (도배) 처벌과 동일하게 처리한다</p>
                                    </div>
                                    <div className="pageCntView"><p>- {selected + 1} / 16 -</p></div>
                                </div>
                             </div> 
                                ...
                                <div className="book_page_content">
                                    <div className="page">
                                        ...
                                        <div className="page__content-blockquote_hang">
                                            ...
                                            <p className="page__content-text1_2">4. 중재의 접점을 찾지 못한경우 왕실 찬반투표 를 요청 할 수있다. 찬반투표는 6조판서가 진행한다 (이조.호조.예조.병조.형조.공조)</p>
                                            <p className="page__content-text1_2">5. 찬반투표 에서 나온 결과에 대해서는 중재 양측모두 받아들이고 중재를 마친다</p>
                                        </div>
