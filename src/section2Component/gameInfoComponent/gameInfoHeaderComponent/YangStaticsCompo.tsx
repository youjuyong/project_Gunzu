...
import { yangStaticsheader } from "../../../utils/ContextList";
    ...
    return (
        <>
          <div className='gameInfoFirstDiv'>
                 { 
                    yangStaticsheader && yangStaticsheader.map(( headerInfo : type, index : number ) => {
...
export default YangStaticsCompo;