...
import { craftsManHeader } from "../../../utils/ContextList";
...
export const CraftsManHeaderCompo = () => {
    ...
    return (
        <>
          <div className='gameInfoFirstDiv'>
                 { 
                    craftsManHeader && craftsManHeader.map(( headerInfo : type, index : number ) => {
...
export default CraftsManHeaderCompo;