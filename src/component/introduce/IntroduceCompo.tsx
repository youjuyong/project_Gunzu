                        ...
                        <div className="contenbox">
                            ...
                            <div className="hpIntroduce2 snans">
                                    <dl>
                                        ...
                                        <dd>
                                            마구간 ( 소개, 유의사항, 탈것 ), 홍길동 ( 전투향상술,<br></br> 무기별 기술 추천 ) 캐릭터 육성에 반드시 필요한 <br></br> 정보들을 제공해 드립니다. 
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>
                                        ...
                                        <dd>
                                           초보자들이 마을 선택에 참고 할 수 있도록 <br></br> 다양한 통계 정보를 제공해 드립니다.
                                        </dd>
                                    </dl>
                                    <dl>
                                        <dt>
                                        ...
                                        <dd>
                                            마을 선택에 참고 할 수 있도록 <br></br> 마을별 장인 정보를 제공해 드립니다.
                                        </dd>
                                    </dl>
                            </div>
                            <div className="hpIntroduce snans">
                                <strong>사이트에 대한 건의, 지적 사항은</strong> <br></br>
                                 홈페이지 하단의 주소로 문의 부탁드립니다. <br></br>
                            </div>
                        </div>
                    </article>
        </div>
