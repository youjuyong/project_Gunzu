    ...
    useLayoutEffect(() => {
     ...
     const dateSumitHandler = () => {
        ...
        const currentDate = new Date(moment().format('YYYY-MM-DD')),
                  endDate = new Date(dateTime[0]["END_TIME"]);
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td colSpan={4} className="tdconten">
                                    {isLoading ? <Loading/> : <> 
                                    <p>안녕하세요. 의정부 마을 대행수입니다~. 현재 {event_term}차 이벤트 날짜를 <span className="dateDisv">{dateTime && dateTime[0]["END_TIME"]}</span>일까지 설문조사 하고있습니다.</p><br></br>
